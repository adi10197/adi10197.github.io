...
![allocationRate](../assets/img/post/garbageCollection102/gcLogsAllocationRates.png)
...
1. Yellow Encircling: Young Generation Space reduction during Minor GC.
2. Cyan Encircling: Time taken to execute Minor GC.
3. White Encircling: Time taken to execute Major GC.
4. Green Encircling: Time at which Full GC began.
...
![promotionRate](../assets/img/post/garbageCollection102/GC_PromotionRate_Example.png)

1. Yellow Encircling: Time taken to execute Major GC.
2. Cyan Encircling: Young Generation Space reduction during Minor GC.
3. White Encircling: Time at which Full GC began.
4. Green Encircling: Heap Space reduction during Full GC.
