...
1. <span style="color:gold">Yellow Encircling</span>: Young Generation Space reduction during Minor GC.
2. <span style="color:aqua">Cyan Encircling</span>: Time taken to execute Minor GC.
3. <span style="color:black">White Encircling</span>: Time taken to execute Major GC.
4. <span style="color:lawngreen">Green Encircling</span>: Time at which Full GC began.
...
1. <span style="color:gold">Yellow Encircling</span>: Time taken to execute Major GC.
2. <span style="color:aqua">Cyan Encircling</span>: Young Generation Space reduction during Minor GC.
3. <span style="color:black">White Encircling</span>: Time at which Full GC began.
4. <span style="color:lawngreen">Green Encircling</span>: Heap Space reduction during Full GC.
